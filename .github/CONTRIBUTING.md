...
NumberTheoreticTransform is developed and maintained primarily by [Jason Bock](https://github.com/JasonBock). New contributions are always welcome!

## Getting started

* Review the [Code of Conduct](https://github.com/JasonBock/NumberTheoreticTransform/blob/main/CODE_OF_CONDUCT.md)
* Make sure you have a [GitHub account](https://github.com/signup/free)
* Engage
  * Submit an [Issue](https://github.com/JasonBock/NumberTheoreticTransform/issues) for your suggestion, assuming one does not already exist
